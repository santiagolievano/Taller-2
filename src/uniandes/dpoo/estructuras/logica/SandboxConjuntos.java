...
public class SandboxConjuntos
{
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	nuevoConjunto.remove(cadenaMinuscula);
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for (Object valores : objetos) {
    		arbolCadenas.add(valores.toString());
    	}
    }
    ...
    public TreeSet<String> invertirCadenas( )
    {
        ...
        TreeSet<String> invertido = new TreeSet<>(inverso);
    ...
    {
    	List<String> nuevaLista = Arrays.asList(otroArreglo);
    	
        return arbolCadenas.containsAll(nuevaLista);
    }
