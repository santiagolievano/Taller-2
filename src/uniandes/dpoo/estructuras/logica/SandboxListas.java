...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros( )
    {
        ...
        nuevaLista.addAll(listaEnteros);
    ...
    public List<String> getCopiaCadenas( )
    {
    	...
    	nuevaLista.addAll(listaCadenas);
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String cadenastr : listaCadenas) {
        	if (cadenastr.equalsIgnoreCase(cadena)) {
        		aparece++;
        	}
        }
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	List<Integer> enterosSinRepetir = new ArrayList<>();
    	
    	for (int i = 0; i < listaEnteros.size(); i++) {
    		int numero = listaEnteros.get(i);
    		if(!enterosSinRepetir.contains(numero)) {
    			int aparece = Collections.frequency(listaEnteros, numero);
    			
    			if(aparece > 1) {
    				repetidos++;
    			}
        		enterosSinRepetir.add(numero);
    		}
    	}
    	return repetidos;
    }
